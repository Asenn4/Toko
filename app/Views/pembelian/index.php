                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <button type="button" class="btn btn-success btn-sm me-1" data-bs-toggle="modal" data-bs-target="#detailModal-<?= $item['id'] ?>">
                                    Detail
                                </button>
                                
                                <?= form_open('pembelian/status/' . $item['id'], ['class' => 'm-0 p-0']) ?>
